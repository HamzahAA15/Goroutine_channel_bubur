...
// // // 	wg.Add(2)
// // // 	go buburProducer(buburJob, &wg)
// // // 	go buburConsumer(buburJob, &wg)
// // // 	wg.Wait()
// // // }

// // // func buburProducer(job *Producer, wg *sync.WaitGroup) {
// // // 	defer wg.Done()
// // // 	i := 0
...
// // // 			select {
// // // 			case job.data <- *currentBubur:

// // // 			case quitChan := <-job.quit:
// // // 				close(job.data)
// // // 				close(quitChan)
// // // 				return
// // // 			}
...
// // // func buburConsumer(job *Producer, wg *sync.WaitGroup) {
// // // 	defer wg.Done()
...
// // // 			err := job.Close()
// // // 			if err != nil {
// // // 				color.Red("error closing the bubur store")
// // // 			}
// // // 		}
// // // 	}
...
// // 	dataOrder := make(chan BuburOrder)
// // 	quit := make(chan chan error)

// // 	go buburProducer(dataOrder, quit)
// // }
...
// // func buburConsumer(orderData chan BuburOrder, wg *sync.WaitGroup) {
// // 	defer wg.Done()
...
// func buburProducer(job *Producer) {
// 	i := 0
...
// 	go buburProducer(buburJob)

// 	for i := range buburJob.data {
// 		if i.buburNumber <= NumberOfBuburs {
// 			if i.success {
// 				color.Green(i.message)
// 				color.Green("order number %d ready to serve", i.buburNumber)
